...
1. **Layout-aware**: quebra por seção/artigo/título (regex de "Art. N", "ANEXO", "CAPÍTULO", numeração de edital) antes de qualquer corte por tamanho.
...
4. **Metadados** obrigatórios: `page_number`, `char_start`, `char_end`, `heading_path`. Sem isso o chunk não é indexado — proveniência é pré-requisito.
